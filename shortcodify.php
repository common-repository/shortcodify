...
// ----  -----------
		...
		private function create_shortcode(){
			...
			if(isset($this->options['sc_widget'])) {
				$this->useWidgets();
			}

			// To use a menu in a widget
			if(isset($this->options['sc_menu'])) {
				$this->useMenus();
			}

			// To use a accordion
			if(isset($this->options['sc_accordion'])) {
				$this->useAccordion();
			}

			// To use a tabs
			if(isset($this->options['sc_tabs'])) {
				$this->useTabs();
			}
		}
